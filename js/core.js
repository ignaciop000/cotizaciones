...
// Render the chart
    chartObj.render = function () {
        ...
        for (var y  in yObjs) {
            ...
            yObjs[y].tooltip.append("rect").attr("x", 8).attr("y","0").attr("width",22).attr("height",'0.75em');
        ...
        function mousemove() {
            ...
            focus.select(".focus.year").text("Fecha: " + chartObj.xFormatter(chartObj.xFunct(d)));
        }
